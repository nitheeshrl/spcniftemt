...
document.getElementById("i1").addEventListener('change',clickupload("fileurl1","","i1"))
function clickupload(folurl,fol,ii){
    ...
    if (file1.value.includes(".png")||file1.value.includes(".JPG")||file1.value.includes(".jpg")||file1.value.includes(".jpeg")){
